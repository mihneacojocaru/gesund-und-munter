...
export default function impressum() {
  return (
    <Layout title={"Gesund und Munter | Datenschutzerklärung"}>
      <section className="impressum container">
        ...
        <p>Franziska Scheidt</p>
        <p>gesund und munter Beratung</p>
        <p>Unterm Homberg 64</p>
        <p>32049 Herford</p>
        <p>Kontakt Datenschutzbeauftragter</p>
        <p>
          E-Mail:{" "}
          <a href="mailto:franziskascheidt@gmail.com">
            franziskascheidt@gmail.com
          </a>
        </p>
        <p>
          <u>Übersicht der Verarbeitungen</u>
        </p>
        <p>
        ...
        <p>
          <u>Bereitstellung des Onlineangebotes und Webhosting</u>
        </p>
        <p>
        ...
        <p>
          <u>Kontakt- und Anfragenverwaltung</u>
        </p>
        <p>
        ...
        <p>
          ...
          gesetzlichen Aufbewahrungspflichten;<strong> Rechtsgrundlagen</strong>
          : Vertragserfüllung und vorvertragliche Anfragen (Art. 6 Abs. 1 S. 1
          lit. b. DSGVO), Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f.
          DSGVO).
        </p>
        <h5>Präsenzen in sozialen Netzwerken (Social Media)</h5>
        <p>
        ...
        <p>
          <u>Änderung und Aktualisierung der Datenschutzerklärung</u>
        </p>
        <p>
        ...
        <p>
          <u>Rechte der betroffenen Personen</u>
        </p>
        <p>
        ...
        <p><a href="https://datenschutz-generator.de">Erstellt mit kostenlosem Datenschutz-Generator.de von Dr. Thomas Schwenke
</a></p>
      </section>
    </Layout>
  );
