...
export default function impressum() {
  return (
    <Layout title={"Gesund und Munter | Impressum"}>
      <section className="impressum container">
        <h2>Impressum „gesund und munter Beratung“</h2>
        <br />
        <h5>Impressum</h5>
        <p>
        ...
        <p>Telefon: 015906335291</p>
        <p>E-Mail: <a href="mailto:franziskascheidt@gmail.com">franziskascheidt@gmail.com</a></p>
        <p>
          <u>Verantwortlich für den Inhalt nach § 55 Abs. 2 RStV</u>
        </p>
        <p>Franziska Scheidt</p>
        <p>gesund und munter Beratung</p>
        <p>Unterm Homberg 64</p>
        ...
        <p>
          <u>Verbraucherstreitbeilegung/Universalschlichtungsstelle</u>
        </p>
        <p>
        ...
        <p>
          ...
          <a href="https://jurarat.de/muster-impressum">jurarat.de</a> zur
          Verfügung gestellt.
        </p>
      </section>
    </Layout>
