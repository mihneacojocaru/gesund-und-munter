  ...
  return (
    <Layout title={'Gesund und Munter | Impressum'}>
        <section className='impressum container'>
            <h2>Impressum Franziska Scheidt Gesundheitsberatung</h2>
            <br />
            <h5>Impressum</h5> 
            ...
            <p>-</p>
            <p><u>Umsatzsteuer-Identifikationsnummer gem. § 27 a Umsatzsteuergesetz:</u></p>
            <p>DE XXX XXX XXX</p>
            <p>-</p>
            ...
            <p><u>Haftungsbeschränkung für externe Links</u></p>
            ...
            <p>Dieses Impressum wurde freundlicherweise von <a href="https://jurarat.de/muster-impressum">jurarat.de</a> zur Verfügung gestellt.</p>   
        </section>
    </Layout>
  )
}
